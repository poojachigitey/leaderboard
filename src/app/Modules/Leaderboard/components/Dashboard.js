...
class EnhancedTable extends React.Component {
  ...
  tick = () =>{
    const val = this.setState({secondsRemaining: this.state.secondsRemaining - 1});
    console.log(val);
    if (this.state.secondsRemaining <= 0) {
      // clearInterval(this.interval);
    this.setState({secondsRemaining:20});
      // clearInterval(this.startagain);
  ...
  componentDidMount = () => {
    ...
    this.startagain = this.setState({ secondsRemaining: this.state.secondsRemaining });
  ...
  render() {
    ...
    return (
      ...
      <div className="counting">
              <span> Updating in the next </span>
             <p>{this.state.secondsRemaining}s</p>
               
              <button className="timeup" onClick={this.onClick} >
                Refresh Now
              </button> 
            </div>
